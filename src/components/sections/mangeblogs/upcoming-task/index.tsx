                    ...
                    <Box mt={1.5}>
                      <Stack alignItems="center" justifyContent="space-between" position="relative">
                        ...
                        <div style={{ display: "flex", gap: "10px" }}>
                          <IconifyIcon icon="hugeicons:pencil-edit-02" fontSize="h6.fontsize" color="text.secondary" sx={{ cursor: "pointer" }} onClick={() => { modalid(data?.id) }} />
                          <IconifyIcon icon="hugeicons:delete-02" fontSize="h6.fontsize" color="red" sx={{ cursor: "pointer" }} onClick={() => { modal2id(data?.id) }} />
                        </div>
                      </Stack>
